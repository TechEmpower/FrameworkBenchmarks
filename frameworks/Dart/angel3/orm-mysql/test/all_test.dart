...
// Angel3 also includes facilities to make testing easier.
//
// `package:angel3_test` ships a client that can test both plain HTTP and WebSockets.
//
...
//
// If you are unfamiliar with Dart's advanced testing library, you can read up here:
