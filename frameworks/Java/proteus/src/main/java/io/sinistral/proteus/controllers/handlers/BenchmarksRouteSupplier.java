...
public class BenchmarksRouteSupplier implements Supplier<HttpHandler> {
	...
	public HttpHandler get() {
		...
		final io.undertow.server.HttpHandler benchmarksDbDispatchPostgresHandler = new io.undertow.server.HttpHandler() {
			@java.lang.Override
			public void handleRequest(final io.undertow.server.HttpServerExchange exchange) throws java.lang.Exception {
		...
		router.addExactPath("/db/dispatch", benchmarksDbDispatchPostgresHandler);
