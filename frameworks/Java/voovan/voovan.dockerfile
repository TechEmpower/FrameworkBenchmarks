...
CMD ["java", "-server", "-XX:+AggressiveOpts", "-XX:+UseBiasedLocking", "-XX:+AggressiveOpts", "-XX:+UseBiasedLocking", "-XX:+UseParallelGC", "-XX:+UseNUMA", "-cp", "./config:voovan.jar:app.jar", "org.voovan.VoovanTFB"]
