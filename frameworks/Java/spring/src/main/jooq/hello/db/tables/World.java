...
public class World extends TableImpl<WorldRecord> {
    ...
    /**
     * The column <code>public.World.id</code>.
     */
    public final TableField<WorldRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.World.randomnumber</code>.
     */
    public final TableField<WorldRecord, Integer> RANDOMNUMBER = createField(DSL.name("randomnumber"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");
