import veb
import os
import db.pg as db_module

const db_connector = 'PostgreSQL'
const db_connector_module = 'db.pg'
const db_connector_port = 5432
const db_connector_varchar = 'TEXT' // Postgres and MySQL differ the text field (used in fortune)
const db_table_world = '"world"'
const db_table_fortune = '"fortune"'
