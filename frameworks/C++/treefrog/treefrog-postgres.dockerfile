...
RUN apt install -yqq g++ gcc libjemalloc-dev qt5-qmake qt5-default qtbase5-dev > /dev/null
RUN apt install -yqq qtbase5-dev-tools libqt5sql5 libqt5sql5-mysql libqt5sql5-psql libqt5qml5 libqt5xml5 > /dev/null
RUN apt install -yqq qtdeclarative5-dev libqt5quick5 libqt5quickparticles5 libqt5gui5 libqt5printsupport5 > /dev/null
RUN apt install -yqq libqt5widgets5 libqt5opengl5-dev libqt5quicktest5 > /dev/null
