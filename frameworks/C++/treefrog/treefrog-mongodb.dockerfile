...
RUN apt-get update -yqq && apt-get install -yqq --no-install-recommends \
    software-properties-common unzip cmake apt-get install -yqq g++ gcc libjemalloc-dev qt5-qmake qt5-default \
    qtbase5-dev qtbase5-dev-tools libqt5sql5 libqt5sql5-mysql libqt5sql5-psql libqt5qml5 libqt5xml5 \
