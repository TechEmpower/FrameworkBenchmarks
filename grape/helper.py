  ...
  try:
    for command in commands:      
      if command.wait_for_exit:
        subprocess.check_call(command.command, shell=True, cwd='grape', stderr=errfile, stdout=logfile)
      else:
        subprocess.Popen(command.command, shell=True, cwd='grape', stderr=errfile, stdout=logfile)
