...
def start(args, logfile, errfile):
  ...
  try:
    ...
    subprocess.Popen("rvm jruby-1.7.8 do jruby --server --fast -S bundle exec torqbox -b 0.0.0.0 -E production", shell=True, cwd="rails-stripped", stderr=errfile, stdout=logfile)
    return 0
