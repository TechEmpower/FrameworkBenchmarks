...
def start(args, logfile, errfile):
  ...
  env = os.environ.copy()
  env["activate.storage.benchmark.factory"] = "net.fwbrasil.activate.storage.relational.async.FinagleMySQLStorageFactory"
  env["activate.storage.benchmark.host"] = args.database_host + ":3306"
  ...
  env["activate.storage.benchmark.poolMaxObjects"] = "4500"
