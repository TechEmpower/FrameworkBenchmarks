...
# Travis adds sources for the extra services they provide. When doing apt
# updates this can interfere with the standard ubuntu installs so we'll reset the sources.
