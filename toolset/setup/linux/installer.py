...
class Installer:
  ...
  def __install_server_software(self):
    ...
    self.__download("http://downloads.sourceforge.net/project/treefrog/src/treefrog-1.7.3.tar.gz")
    self.__run_command("tar xzf treefrog-1.7.3.tar.gz")
    self.__run_command("rm treefrog-1.7.3.tar.gz")
    self.__run_command("./configure", cwd="treefrog-1.7.3")
    self.__run_command("make", cwd="treefrog-1.7.3/src")
    self.__run_command("sudo make install", cwd="treefrog-1.7.3/src")
    self.__run_command("make", cwd="treefrog-1.7.3/tools")
    self.__run_command("sudo make install", cwd="treefrog-1.7.3/tools")
