...
class Installer:
  ...
  def __install_server_software(self):
    ...
    # Ur/Web
    #
    self.__download("http://www.impredicative.com/ur/urweb-20140704.tgz");
    self.__run_command("tar xzf urweb-20140704.tgz");
    self.__run_command("./configure", cwd="urweb-20140704")
    self.__run_command("make", cwd="urweb-20140704")
    self.__run_command("sudo make install", cwd="urweb-20140704")
